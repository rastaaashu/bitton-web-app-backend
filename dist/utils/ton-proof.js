...
exports.generateTonChallenge = generateTonChallenge;
exports.normalizeTonAddress = normalizeTonAddress;
 ...
 */
function verifyTonProof(proof, expectedPayload, expectedDomain) {
    try {
        // 1. Parse TON address
        ...
        logger_1.logger.error("TON proof verification error:", err);
...
function verifyEd25519(message, signature, publicKeyRaw) {
    try {
        ...
        return (0, crypto_1.verify)(null, message, publicKey, signature);
    }
    catch (err) {
        logger_1.logger.error("Ed25519 verification error:", err);
        return false;
    }
}
...
//# sourceMappingURL=ton-proof.js.map